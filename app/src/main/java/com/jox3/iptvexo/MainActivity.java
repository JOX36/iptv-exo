...
public class MainActivity extends AppCompatActivity {
    ...
    class CatalogBridge {
        ...
        @JavascriptInterface
        public void openPlayer(String url, String name, String group, String type, String logo, String itemId) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1001 && data != null) {
            ...
            if (favAdded && itemId != null) {
                webView.evaluateJavascript("S.favs.add('" + itemType + "_" + itemId + "');saveFavs();", null);
            } else if (favRemoved && itemId != null) {
                webView.evaluateJavascript("S.favs.delete('" + itemType + "_" + itemId + "');saveFavs();", null);
            }
        }
    }
